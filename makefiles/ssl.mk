...
$(DIR_SSL)/apiserver.pem: $(DIR_SSL)/ca.pem
	$(INIT-SSL) $(DIR_SSL) apiserver k8s-apiserver \
		IP.1=127.0.0.1,IP.2=10.0.0.15,IP.3=10.3.0.1,DNS.1=master.k8s.internal,DNS.2=*.us-west-1.elb.amazonaws.com

$(DIR_SSL)/ca.pem: | $(DIR_SSL)/ ; $(INIT-SSL-CA) $(DIR_SSL)

$(DIR_SSL)/etcd.pem: $(DIR_SSL)/ca.pem
	$(INIT-SSL) $(DIR_SSL) etcd coreos-etcd \
		IP.1=127.0.0.1,IP.2=10.0.0.10,IP.3=10.0.0.11,IP.4=10.0.0.12,DNS.1=*.k8s.net
